...
LEVERAGE = 5        # PÁKA (Přidáno, aby kód nespadl)
RISK_PCT = 0.01     # Risk na obchod (1%)

# Objem obchodu
# Pro cTrader FIX: Často "1" = 1 kontrakt (1 BTC).
# Pro test dáme "0.01" (jedna setina bitcoinu), což je bezpečné.
# Pokud to server odmítne (příliš málo), zkusíme "0.1".
VOLUME_TO_TRADE = "0.01" 
