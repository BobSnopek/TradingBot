...
# Objem obchodu
# Pro cTrader FIX: '1000' units = 0.01 BTC (obvykle).
# Pokud by to nešlo, zkus '1' nebo '0.01'.
...
def run_btc_logic():
    ...
    if signal_now == 1: # CHCEME LONG
        ...
        # Pokud chceš striktně zavírat, když signál zmizí, odkomentuj toto:
        # if aktualni_pozice == "BUY":
        #     loguj_aktivitu("Zavírám LONG (Signál zmizel)")
        #     odeslat_fix_prikaz("SELL", VOLUME_TO_TRADE, is_entry=False)
        #     save_position("NONE")
        # elif aktualni_pozice == "SELL":
        #     loguj_aktivitu("Zavírám SHORT (Signál zmizel)")
...
def run_btc_logic():
    ...
    loguj_aktivitu(f"AI: L={prob_l:.2f}, S={prob_s:.2f} -> Signál: {signal_now}")
    ...
    if signal_now == 1: # CHCEME LONG
        ...
        # Zde můžeš přidat logiku pro zavření, pokud chceš být "Out of market"
